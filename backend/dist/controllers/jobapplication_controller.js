...
exports.createJobApplication = void 0;
var JobApplication_1 = __importDefault(require("../models/JobApplication"));
var Job_1 = __importDefault(require("../models/Job"));
var User_1 = __importDefault(require("../models/User"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var createJobApplication = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, jobId, email, job, user, jobApplication, payload, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                user = new User_1.default({ name: email, email: email, location: '', isEmailVerified: false });
                return [4 /*yield*/, user.save()];
            case 3:
                _b.sent();
                _b.label = 4;
            case 4:
                jobApplication = new JobApplication_1.default({
                    jobId: jobId,
                    userId: user._id
                });
