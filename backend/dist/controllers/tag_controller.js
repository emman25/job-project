...
exports.deleteTag = exports.updateTag = exports.createTag = exports.getAlltag = void 0;
var Tag_1 = __importDefault(require("../models/Tag"));
var getAlltag = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var tag, err_1;
...
var createTag = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                tag = new Tag_1.default({ name: name });
...
var updateTag = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var TagId, name, tag, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                TagId = req.params.id;
...
var deleteTag = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Tag_1.default.findByIdAndDelete(TagId)];
            case 2:
                tag = _a.sent();
                if (!tag) {
